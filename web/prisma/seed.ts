...
async function main() {
  ...
  // 案件データを作成
  // unitPriceは万円単位で保存（データベースのスキーマでは「単位：円」と記載されているが、実際には万円単位で保存）
  const jobs = [
    {
      ...
      description:
        "月間1000万PVを超える大規模WebサービスのReact/TypeScriptによるフロントエンド開発に携わっていただきます。",
      originalTitle: "【急募】React/TS エンジニア募集 〜月額85万円 商流2次請け",
      originalBody:
        "フロントエンドエンジニアを募集しております。React、TypeScript経験必須です。",
    ...
    },
    {
      ...
      description:
        "Go言語を用いたマイクロサービスの開発・運用に携わっていただきます。",
    ...
    },
    {
      ...
      description:
        "新規事業の立ち上げに伴い、フロント・バックエンド両方の開発をお願いします。",
      originalTitle: "【新規案件】フルスタックエンジニア 単価78万 エンド直",
      originalBody:
        "新規プロジェクトにてフルスタックエンジニアを募集しております。",
    ...
    },
    {
      ...
      description:
        "Vue.js 3系とNuxt.jsを使用したモダンなSPA開発プロジェクトです。",
